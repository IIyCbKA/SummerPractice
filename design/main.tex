...
\begin{document}
	...
	\begin{onehalfspacing}
		...
		\input{tasks/first_task} \newpage

		\input{tasks/second_task} \newpage

		\input{tasks/third_task} \newpage

		\input{tasks/fourth_task} \newpage

		\input{tasks/fifth_task} \newpage

		\input{tasks/sixth_task} \newpage

        \input{tasks/seventh_task} \newpage
	\end{onehalfspacing}
\end{document}